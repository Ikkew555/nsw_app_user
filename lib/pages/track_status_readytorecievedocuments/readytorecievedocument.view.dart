...
class ReadyToRecieveDocumentView extends StatefulWidget {
  const ReadyToRecieveDocumentView(
      {Key? key, required this.readyToRecieveDocumentDto})
      : super(key: key);

  final ReadyToRecieveDocumentDto readyToRecieveDocumentDto;

  @override
  State<ReadyToRecieveDocumentView> createState() =>
      _ReadyToRecieveDocumentViewState();
}

class _ReadyToRecieveDocumentViewState
    extends State<ReadyToRecieveDocumentView> {
  ...
  void initState() {
    super.initState();
    setState(() {
      readyToRecieveDocumentDto = widget.readyToRecieveDocumentDto;
    });
  }
  ...
  // List ที่เอาไว้แสดง
  List<ReadytorecievedocumentModel> display_list =
  ...
  void updateList(String value) {
    setState(() {
      display_list = items_readytorecieved
          .where((element) =>
  ...
  HandleonPressedShowSystem() {
    readyToRecieveDocumentDto.onPressedShowSystem.call();
  }
}
